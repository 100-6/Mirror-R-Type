...
** Mirror-R-Type
** File description:
** Test loading the SFML Graphics Plugin
*/
...
int main() {
    try {
        ...
        if (graphics->create_window(800, 600, "SFML Plugin Test")) {
            ...
            // Draw a line
            graphics->draw_line(
                engine::Vector2f(100.0f, 500.0f),
                engine::Vector2f(700.0f, 500.0f),
                engine::Color::Green,
                3.0f
            );
